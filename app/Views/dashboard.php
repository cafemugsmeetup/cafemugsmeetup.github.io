            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        ...
                        <p>Silahkan menikmati makanan yang tersedia</p>
                    </li>
                </ul>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Pesanan Berhasil dibuat <br> Atas nama <b id="namaPemesan"></b> dengan nomor meja <b id="lokasiMeja"></b>.
                                <br> <br> Mohon ditunggu ya kak. Semoga kakak dapat menikmati suasana nyaman di cafe ini. <br> <br>
                                <i>Mohon untuk langsung dibayar ya kak</i> <br> <br>
                                <b>Terima kasih ^^</b>
                            </div>
                            <div class="modal-footer">
